 ...
 */
final class Version20220514191954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE planning (id INT AUTO_INCREMENT NOT NULL, activity_id INT DEFAULT NULL, room_nb INT NOT NULL, begin_hour VARCHAR(100) NOT NULL, end_hour VARCHAR(100) NOT NULL, date DATE NOT NULL, INDEX IDX_D499BFF681C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
